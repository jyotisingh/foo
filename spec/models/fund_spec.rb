...
describe Fund do
  it "should save fund" do
    fund = Fund.create!({:name => "Fund 1", :fund_type => "Income Retail", :nav => 2000})
    fund.name.should == "Fund 1"
    fund.fund_type.should == "Income Retail"
  ...
  it "should archive old navs" do
    ...
    fund.archived_navs[0].date.to_s.should == "2012-04-27"
    fund.archived_navs[0].nav.should == 100.5
  end
end
